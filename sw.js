const STATIC_CACHE="copenhague-v358-static-v52";
const RUNTIME_CACHE="copenhague-v358-runtime-v52";
const STATIC_FILES=[
  "/",
  "/index.html",
  "/shared-sync.js",
...
`;
    const extras=`\n;(function(){const s=document.createElement("script");s.src="/ui-fixes-v7.js?v=32";s.async=false;document.head.appendChild(s)})();\n`;
