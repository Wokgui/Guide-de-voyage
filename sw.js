const STATIC_CACHE="copenhague-v343-static-v21";
const RUNTIME_CACHE="copenhague-v343-runtime-v21";
const STATIC_FILES=[
  "/",
  "/index.html",
  "/shared-sync.js",
...
`;
    const extras=`\n;(function(){const s=document.createElement("script");s.src="/ui-fixes-v7.js?v=23";s.async=false;document.head.appendChild(s)})();\n`;
