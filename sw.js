const STATIC_CACHE="copenhague-v343-static-v20";
const RUNTIME_CACHE="copenhague-v343-runtime-v20";
const STATIC_FILES=[
  "/",
  "/index.html",
  "/shared-sync.js",
...
`;
    const extras=`\n;(function(){const s=document.createElement("script");s.src="/ui-fixes-v7.js?v=22";s.async=false;document.head.appendChild(s)})();\n`;
