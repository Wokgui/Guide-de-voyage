const STATIC_CACHE="copenhague-v338-static-v1";
const RUNTIME_CACHE="copenhague-v338-runtime-v1";
const STATIC_FILES=[
  "/",
  "/index.html",
  "/shared-sync.js",
  "/cloud-backup.js?v=3",
  "/header-prestige.js?v=338",
