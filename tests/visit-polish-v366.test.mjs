...
assert.match(polish,/\.cph-section-title\{[\s\S]*?left:50%!important;[\s\S]*?transform:translate\(-50%,-50%\)!important/,'titre et icône doivent être centrés indépendamment de la flèche');
...
assert.match(sw,/copenhague-v358-static-v54/,'le cache doit être renouvelé');
...
console.log(JSON.stringify({ok:true,sections:'single-right-arrow-centered',notes:'centered-and-justified',duration:'full-tile-centered',departure:'hidden-before-paint',days:'toggle-v366'},null,2));
