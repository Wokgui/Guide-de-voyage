...
assert.match(sw,/copenhague-v358-static-v67/,'cache statique non versionné pour la correction photo');
assert.match(sw,/copenhague-v358-runtime-v67/,'cache runtime non versionné pour la correction photo');
